...
class apiService {
    ...
    #processResponse = (status, endPoint, response) => {
        ...
        if (status) {
            ...
            console.log(
                `%c ${endPoint}`,
                "color: green; font-family:sans-serif; font-size: 20px; font-weight: 700", data
            );
            return data;
        } else {
            if (response?.message === "Network Error") {
                ...
                console.log(
                    `%c ${endPoint}`,
                    "color: red; font-family:sans-serif; font-size: 20px; font-weight: 700", data
                );
                return data;
            } else {
                let data = {
    ...
    sendGetWithAuth = (payload, endPoint, callback) => {
        ...
        axiosWithAuth.get(`${baseUrl}/${endPoint}`, payload).then(
            (response) => {
    ...
    sendGetWithoutAuth = (payload, endPoint, callback) => {
        ...
        axios.get(`${baseUrl}/${endPoint}`, payload).then(
            (response) => {
                callback(this.#processResponse(true, endPoint, response));
            }).catch(
                (response) => {
    ...
    sendPostWithAuth = (payload, endPoint, callback) => {
        ...
        axiosWithAuth.post(`${baseUrl}/${endPoint}`, payload).then(
            (response) => {
                callback(this.#processResponse(true, endPoint, response));
    ...
    sendPostWithoutAuth = (payload, endPoint, callback) => {
        ...
        axios.post(`${baseUrl}/${endPoint}`, payload).then(
            (response) => {
                callback(this.#processResponse(true, endPoint, response));
    ...
    sendDeleteWithAuth = (payload, endPoint, callback) => {
        ...
        axiosWithAuth.delete(`${baseUrl}/${endPoint}/${payload}`).then(
            (response) => {
                callback(this.#processResponse(true, endPoint, response));
    ...
    sendDeleteWithAuthAndPayloadInBody = (payload, endPoint, callback) => {
        ...
        axiosWithAuth.delete(`${baseUrl}/${endPoint}/`, {data: payload}).then(
            (response) => {
                callback(this.#processResponse(true, endPoint, response));
    ...
    sendPutWithAuth = (payload, endPoint, callback) => {
        ...
        axiosWithAuth.put(`${baseUrl}/${endPoint}/`, payload).then(
            (response) => {
                callback(this.#processResponse(true, endPoint, response));
